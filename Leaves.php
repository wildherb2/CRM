...
class Leaves extends Pre_loader {
    ...
    function assign_leave() {
        ...
        $leave_data['applicant_id'] = $this->input->post('applicant_id');
    ...
    private function _make_row($data) {
        ...
        return array(
            ...
            modal_anchor(get_uri("leaves/application_details"), "<i class='fa $option_icon'></i>", array("class" => "edit", "title" => lang('application_details'), "data-post-applicaiton_id" => $data->id, "applicaiton_id"))
        );
    }
    ...
    function application_details() {
        validate_submitted_data(array(
            "applicaiton_id" => "required|numeric"
        ));

        $applicaiton_id = $this->input->post('applicaiton_id');
